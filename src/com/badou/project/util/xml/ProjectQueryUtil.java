package com.badou.project.util.xml;
...
import com.badou.project.queryvo.Function;
import com.badou.project.queryvo.TypeDef;
import com.badou.project.widget.Module;
import com.badou.project.widget.Project;
public class ProjectQueryUtil {
	 ...
	 */
	public static Module getModule(String path,Project project) throws Exception{
	 ...
	 * @throws KoalaException
	 */
	public static boolean isParentProject(String path) throws Exception{
		/*path=path.replaceAll("\\\\", "/");
	 ...
	 * @return
	 */
	public static Project getProject(String path) throws Exception{
		return null;
		/*path=path.replaceAll("\\\\", "/");
		if(path.endsWith("/"))path=path.substring(0,-1);
		String projectPom = path+"/pom.xml";
	 ...
	 * @throws DocumentException 
	 */
	public static Project parseProject(String path) throws Exception{
		path=path.replaceAll("\\\\", "/");
	...
	public static void main(String[] args) throws Exception {
		String path="/home/bduser29/Career/work/workspace1/zljg_tags";
		Project pro =  ProjectQueryUtil.parseProject(path);
